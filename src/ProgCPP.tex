...
\begin{document}	
	...
	\lstset{style=cpp}
\begin{multicols*}{4}
	\input{sections/01_Aufbau}
	\input{sections/02_Variablen}
	\input{sections/03_Operatoren}
	\input{sections/04_Logische_Konstrukte}
	\input{sections/05_iostream}
	\input{sections/06_Binarzahlen}
	\input{sections/07_Kontrollstrukturen}
	\input{sections/08_Arrays}
	\input{sections/09_Structures}
	\input{sections/10_Dynamisch.tex}
	\input{sections/11_Container.tex}
	\input{sections/12_Memory.tex}
	\input{sections/13_Binary.tex}
	
	\newpage
	\input{sections/05_refenzen}
	\input{sections/06_Funktionen}
	\input{sections/07_Pointer}
	\input{sections/08_Vektoren}
	\input{sections/09_Strings}
	\input{sections/10_Klassen}
	\input{sections/11_Iterators}
	\input{sections/12_Subtyping}
\end{multicols*}		
\newpage
\listoftodos[Notes]
\end{document}
